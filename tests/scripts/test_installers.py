...
def test_install_sh_fresh_install_is_verified(posix_harness: PosixHarness) -> None:
    ...
    assert any(
        call.startswith(
            ...
            "https://github.com/heyogeshcode/free-claude-code/archive/refs/heads/main.zip"
        )
        for call in calls
    )
...
def test_install_ps1_preserves_valid_existing_tools(
    ...
    assert download_calls == [
        "download:https://raw.githubusercontent.com/heyogeshcode/"
...
def test_installers_use_native_clients_and_single_python_selection() -> None:
    ...
    assert (
        "https://raw.githubusercontent.com/heyogeshcode/free-claude-code/"
